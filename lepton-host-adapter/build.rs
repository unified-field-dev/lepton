...
// Build script: compiles `schemas/*_valence_schema.rs` (token lifecycle tables) into
// generated Valence models under `OUT_DIR`, included by `src/generated.rs`. Not part of
