//! Logical database name/storage constants for Lepton host-adapter schemas.
//!
...
/// Default Valence storage evaluator for host-adapter schemas.
...
mod tests {
    ...
    #[test]
    fn embedded_logical_names() {
        assert_eq!(IDENTITY_LOGICAL_NAME, "default");
        assert_eq!(EMBEDDED_LOGICAL_NAMES, &["default"]);
    }
}
